...
public class Container8 {
    ...
    public static void addWater(int containerId, float amount) {
        ...
        Container8.amount[groupId] += amount / groupSize;
    }
...
//    可以使用 java8 的 stream 库简化代码
  ...
  public static void main(String[] args) {
    int a = Container8.newContainer(),
      b = Container8.newContainer(),
      c = Container8.newContainer(),
      d = Container8.newContainer();

      Container8.addWater(a, 12);
      Container8.addWater(d, 8);
      Container8.connectTo(a, b);

    // a: 6.000000, b: 6.000000, c: 0.000000, d: 8.000000
    System.out.println(String.format("a: %f, b: %f, c: %f, d: %f", Container8.getAmount(a), Container8.getAmount(b), Container8.getAmount(c), Container8.getAmount(d)));
  }
}
